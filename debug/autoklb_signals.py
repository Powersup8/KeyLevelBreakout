...
REV_PROXIMITY_TOL = 0.55       # loop AO2: cascade AO1 tighter (0.60→0.55 — continue REV proximity exploration)
...
VWAP_RECLAIM_ENABLED = False  # loop R3: disable VWAP reclaim entirely
